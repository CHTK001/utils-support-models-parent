# fetch-style-candy.ps1
# 下载 Fast Neural Style Transfer - Candy（糖果风格）ONNX 模型
# 模型大小约 6.6MB
...
if (Test-Path $OutFile) {
    Write-Host "已存在: $ModelName [Candy 糖果风格]" -ForegroundColor Green
    exit 0
}

Write-Host "下载: $ModelName [Candy 糖果风格]..." -ForegroundColor Cyan
try {
