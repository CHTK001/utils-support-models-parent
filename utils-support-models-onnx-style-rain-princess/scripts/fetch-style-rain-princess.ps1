# fetch-style-rain-princess.ps1
# 下载 Fast Neural Style Transfer - Rain Princess（雨中公主）ONNX 模型
# 模型大小约 6.6MB
...
if (Test-Path $OutFile) {
    Write-Host "已存在: $ModelName [Rain Princess 雨中公主]" -ForegroundColor Green
    exit 0
}

Write-Host "下载: $ModelName [Rain Princess 雨中公主]..." -ForegroundColor Cyan
try {
